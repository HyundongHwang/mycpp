...
class LogSlothLogger {
 public:
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, int iValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, long lValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, float fValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, double dValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, std::string strValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValue(std::string strFilePath, int nLineNum, std::string strFuncName,
                                   std::string strValueName, const char* szValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValueAsPtr(std::string strFilePath, int nLineNum, std::string strFuncName,
                                        std::string strValueName, void* pValueValue) {
    char szTmp[1024] = {
        0,
    };
  ...
  static std::string PrintLogValueAsHex(std::string strFilePath, int nLineNum, std::string strFuncName,
                                        std::string strValueName, char* pValueValue, int sizeValueValue) {
    std::string strLog;
  ...
  static std::string PrintLogCaller(std::string strFilePath, int nLineNum, std::string strFuncName,
  ...
  static std::string PrintLogCallee(std::string strFilePath, int nLineNum, std::string strFuncName,
                                    std::string strCallParam, ...) {
    char szCallParam[1024] = {
        0,
    };
  ...
  static std::string PrintLog(std::string strFilePath, int nLineNum, std::string strFuncName, std::string strFormat,
                              ...) {
...
#if defined(ANDROID) || defined(__ANDROID__)
    snprintf(szPrettyLog, 1024, "%s:%d:%s %s", strFileName.c_str(), nLineNum, strFuncName.c_str(), szLog);
    ...
    snprintf(szPrettyLog, 1024, "%s.%03d %d %d D LOGSLOTH: %s:%d:%s %s \n", szCurTime, ms, pid, tid,
             strFileName.c_str(), nLineNum, strFuncName.c_str(), szLog);
...
class LogSlothLoggerScoped {
 public:
  ...
  ~LogSlothLoggerScoped() { LogSlothLogger::PrintLog(_strFilePath, _nLineNum, _strFuncName, "↗↗↗"); }
